...
public class BoardController {
	...
	@ResponseBody
	public List<BoardDTO> list1(@RequestParam(value="tag", required = false, defaultValue = "1") String tag, @RequestParam(value="word", required=false, defaultValue="") String word, HttpSession session) {
	...
	public List<BoardDTO> list2(@RequestParam("tag") String tag, @RequestParam(value="word", required=false, defaultValue="") String word, @RequestParam("startNum") String startNum, @RequestParam("endNum") String endNum, HttpSession session) {
	...
	public String checkId(@RequestParam String id) {
		...
		if(memberDTO != null) {return "exist";}
